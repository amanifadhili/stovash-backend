...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/abayo/code/node/electronic-shop/electronic-shop-api/apps/sales-service/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/sales-service/src/generated/prisma",
    "sales-service/src/generated/prisma",
  ]
...
path.join(process.cwd(), "apps/sales-service/src/generated/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/sales-service/src/generated/prisma/schema.prisma")
